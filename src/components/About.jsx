...
const About = () => {
  return (
    <Box as="section" minH={"95vh"} pt="110px" pb='6' bgColor={"gray.900"}>
      <Container maxW={["90vw",'75vw']} lineHeight={[1.2, 1.5]} color="white">
        ...
        <Text py={2} lineHeight={[2]} fontSize={["18px", "20px", "22px"]}>
          ...
          educational needs of the people, initiate all available human and
